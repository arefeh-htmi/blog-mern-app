...
import BloggingAppCMSEditor from '../../../components/bloggingappcmsEditor';
        ...
        <Grid item md={8}>
          ...
          <form>
            ...
            <Field
              ...
              required
            />
            <BloggingAppCMSEditor content={content} onChange={this.onEditorChange} />
          </form>
        </Grid>
        <Grid item md={4}>
