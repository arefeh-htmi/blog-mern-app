...
function getSiteController (req, res, next) {
...
function getThemesController (req, res, next) {
...
function PostWidgetActionController(req, res, next) {
  const { currentUser } = req;
...
function deleteWidgetController (req, res, next)  {
  const { currentUser } = req;
